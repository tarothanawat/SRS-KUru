...
- All ten core MVP features described in Chapter 1. Portfolio readiness checker (Feature 8) scoped to top 10 programs. Recommendation engine (Feature 2) covers all KU programs.
