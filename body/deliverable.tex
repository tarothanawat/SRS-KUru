...
The delivered MVP software will include: a deployed web application accessible at a public URL; the data ingestion pipeline for มคอ.2, TCAS, and fee-related document processing; the Supabase/pgvector retrieval layer; the RAG pipeline; simplified Pipeline~B2 program recommendation; semantic program search; static PLO/profile visualisation; and recommendation explanation. Neo4j graph reasoning, the full hybrid recommendation engine, behavioural blending, portfolio readiness checking, program comparison, career explorer, and curriculum timeline visualisation are Phase~2 target-system deliverables rather than MVP pass/fail requirements.
