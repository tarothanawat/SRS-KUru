...
Table~\ref{tab:schedule} presents the project schedule organized into phases aligned with the two-week sprint cadence. Data collection gates the start of feature development, and evaluation runs in the final two weeks before the demonstration.
...
\hline
Weeks 7--8 & Core frontend & Interest discovery UI, program recommendation cards, program detail full page, PLO spider chart with student overlay \\
\hline
Week 9 & Extended frontend & PLO Explorer with semantic search and pin tray, portfolio readiness checker (top 10 programs), curriculum timeline visualiser, program comparison view, TCAS guide with personal eligibility check, saved profile dashboard \\
\hline
