...
The MVP covers the top 10 KU programs for recommendation and portfolio readiness checking, with architecture designed to extend to all KU programs. The system is evaluated using the RAGAS framework for RAG quality and Mean Reciprocal Rank (MRR) and NDCG@5 for recommendation quality.
