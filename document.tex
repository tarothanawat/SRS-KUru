...
\usepackage{ragged2e}  % Better ragged-right text in table cells
...
\def \srsTitle{KUru: AI-Powered University Program Advisor for KU Program Selection using RAG and Semantic Recommendation}
\def \srsTitleDisplay{KUru: AI-Powered University Program Advisor\\for KU Program Selection using RAG\\and Semantic Recommendation}
